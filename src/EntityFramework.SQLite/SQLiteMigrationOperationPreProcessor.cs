    ...
    public class SQLiteMigrationOperationPreProcessor : MigrationOperationVisitor<SQLiteMigrationOperationPreProcessor.Context>
    {
        ...
        public class RebuildTableHandler : TableOperationHandler
        {
            ...
            public override IEnumerable<MigrationOperation> HandleOperations(Context context)
            {
                ...
                // TODO: Figure out if there are restrictions when copying data and handle here.
                ...
                {
                    // TODO: Consider having a temporary table name generator that can be used by ModelDiffer and this.
                    sourceTableName = new SchemaQualifiedName("__mig_tmp__0", sourceTableName.Schema);

                    yield return new RenameTableOperation(TableName, sourceTableName);
                }
                ...
                yield return new DropTableOperation(sourceTableName);
            }
        }
